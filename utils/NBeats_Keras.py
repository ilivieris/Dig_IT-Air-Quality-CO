...
class NBeatsNet:
    ...
    def create_block(self, x, e, stack_id, block_id, stack_type, nb_poly):
        ...
        backcast_ = {}
        forecast_ = {}
        d1 = reg(Dense(self.units, activation='swish', name=n('d1')))
        d2 = reg(Dense(self.units, activation='swish', name=n('d2')))
        d3 = reg(Dense(self.units, activation='swish', name=n('d3')))
        d4 = reg(Dense(self.units, activation='swish', name=n('d4')))
